...
uint256 hashGenesisBlock("0x8d199f44e16c4f578d997fef08e948c07c16868a0cd37f95173c02fb37ad2a36");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 10000); // Litecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Litecoin: 3.5 days
static const int64 nTargetSpacing = 5 * 60; // Litecoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x150e05d842b676563e91aabbc771d1d4889b48012514f66fa3271f6886a5f506");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0439194d8efe9710bc656f7370d23b098e7d0f022accc6093142f20188fbe79284ac6618854ecb672f95a63bc706480cc5f907ab0282b668458fa3dc1620c2111a") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1536769583;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2088482323;

        if (fTestNet)
        {
            block.nTime    = 1536769505;
            block.nNonce   = 386663414;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x6ac24a00927f88085d373516d9e1776c7b1e5f5c4909a5712c0b01c92bedfabb"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc3, 0xba, 0xd3 }; // Litecoin: increase each by adding 2 to bitcoin's value.
